...
def forge_keyed_mac( orig_message, orig_mac, keylen_guess ):

    addition = ";admin=true"
    (a,b,c,d) = md4_recover_state( orig_mac )
    ...
    forged_mac = md4_hash_set_state( forged_addition_bytes, a, b, c, d, forced_length, debug_state=False )
